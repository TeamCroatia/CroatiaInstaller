...
!define MUI_ICON "C:\Users\kpjhg\Documents\Project\DeveloperInstaller\icon.ico"
...
Section "MainSection" SEC01
  ...
  DetailPrint "모드 적용중..."
  nsExec::ExecToLog '"7z.exe" x "GameLib.7z.001" "-o$INSTDIR" "-aoa"'
  DetailPrint "임시파일을 삭제하는중...."
  Delete "GameLib.7z.001"
  Delete "GameLib.7z.002"
  Delete "GameLib.7z.003"
  Delete "GameLib.7z.004"
  Delete "GameLib.7z.005"
  Delete "GameLib.7z.006"
  Delete "GameLib.7z.007"
  Delete "GameLib.7z.008"
  Delete "GameLib.7z.009"
  Delete "GameLib.7z.010"
  Delete "GameLib.7z.011"
  Delete "GameLib.7z.012"
  Delete "GameLib.7z.013"
  Delete "GameLib.7z.014"
  Delete "GameLib.7z.015"
  Delete "GameLib.7z.016"
  Delete "GameLib.7z.017"
  Delete "GameLib.7z.018"
  Delete "GameLib.7z.019"
  Delete "GameLib.7z.020"
  Delete "GameLib.7z.021"
  Delete "GameLib.7z.022"
  Delete "GameLib.7z.023"
  Delete "GameLib.7z.024"
  Delete "GameLib.7z.025"
  Delete "GameLib.7z.026"
  Delete "GameLib.7z.027"
  Delete "GameLib.7z.028"
  Delete "GameLib.7z.029"
  Delete "GameLib.7z.030"
  DetailPrint "완료"
  SetOutPath "$INSTDIR"
SectionEnd
